...
import '../vendor/content-slider-announcer/1.1.2/assets/js/content-slider-announcer.js';

const contentSliderAnnouncerHtmlUrl = new URL('../vendor/content-slider-announcer/1.1.2/index.html', import.meta.url);
